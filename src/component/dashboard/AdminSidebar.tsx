    ...
    <>
      ...
      >
        ...
        <div className="p-3 border-t border-white/10">
          <Link
            href="/"
            className="flex items-center gap-3.5 px-3.5 py-3 rounded-lg text-xs font-mono text-rose-400 hover:bg-rose-500/10 transition-colors w-full"
            title={collapsed ? "Exit to Main Store" : undefined}
          >
